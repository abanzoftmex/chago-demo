...
const WeeklyBreakdownEntradas = ({
  ...
  const { selectedWeekOverview, handleWeekOverviewClick, clearWeekOverview } = useWeekDayBreakdown({
    transactions, generals, concepts, subconcepts, filters, currentDate, type: "entrada",
  });
          ...
          <table className="min-w-full divide-y divide-border">
            <thead className="bg-lime-100">
              <tr>
                ...
                <th colSpan={stats.weeklyBreakdown.weeks.length} className="px-4 py-2 text-center text-xs font-bold bg-lime-200 text-lime-800 tracking-wider border-r-2 border-lime-200">
                  Semanas
                </th>
            ...
            <tbody className="bg-background divide-y divide-border">
              ...
              <tr className="bg-gray-200 font-bold border-t-2 border-gray-400">
                ...
                {stats.weeklyBreakdown.weeks.map((week, index) => {
                  const weekTotal = Object.entries(stats.weeklyBreakdown.entradas || {}).reduce(
